...
function TermsandconList() {
  // Fetch testimonials
  const [privacyPolicies, setPrivacyPolicies] = useState([]);

  useEffect(() => {
    // Fetch privacy policy data from the API
    fetch(Baseurl + "/api/v1/terms")
      ...
      .catch((error) => {
        console.error("Error fetching privacy Termsandcondition:", error);
      });
  }, []);
  ...
  const deletePrivacyPolicy = async (id) => {
    try {
      ...
      const result = await Swal.fire({
        title: "Are you sure?",
        text: "You will not be able to recover this Privacy Termsandcondition!",
        icon: "warning",
      ...
      if (result.isConfirmed) {
        ...
        const response = await fetch(Baseurl + "/api/v1/terms/delete", {
          method: "DELETE",
          headers: {
        ...
        if (!response.ok) {
          throw new Error("Failed to delete Terms&Condition");
        }
        ...
        Swal.fire(
          "Deleted!",
          "Your Terms&Condition has been deleted.",
          "success"
        );
      }
    } catch (error) {
      console.error("Error deleting  Terms&Condition:", error);
      Swal.fire("Error", "Failed to delete Terms&Condition.", "error");
    }
  };
            ...
            <div className="row">
              <div className="col-12">
                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 className="mb-sm-0">Terms&Condition</h4>
                  ...
                  <div className="card-header border-0">
                    <div className="row align-items-center gy-3">
                      <div className="col-sm">
                        <h5 className="card-title mb-0">Terms&Condition</h5>
                      </div>
...
export default TermsandconList;
